...
local updateURL = "https://raw.githubusercontent.com/ТВОЙ_ГИТХАБ/script.lua" -- Ссылка на актуальный скрипт
local scriptPath = thisScript().path  -- Автоматическое определение пути скрипта
local checkInterval = 600000  -- Интервал проверки обновлений (10 минут)
